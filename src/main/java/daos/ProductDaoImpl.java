...
public class ProductDaoImpl extends Dao implements ProductDao
{
    ...
    public ProductDaoImpl(String databaseName)
    {
        super(databaseName);
    }
    ...
    public List<Product> getAllProducts()
    {
        ...
        try{
            ...
            System.out.println("Exception occurred in the getAllProducts() method: " + e.getMessage());
        } finally {
            try {
                if (rs != null) {
                    rs.close();
                ...
                System.out.println("Exception occurred in the finally section of the getAllProducts() method: " + e.getMessage());
            }
        }
    ...
    public Product getProductByCode(String code)
    {
        ...
        try{
            ...
            System.out.println("Exception occurred in the getProductByCode() method: " + e.getMessage());
        } finally {
            try {
                if (rs != null) {
                    rs.close();
                ...
                System.out.println("Exception occurred in the finally section of the getProductByCode() method: " + e.getMessage());
            }
        }
        return p;
    }
    ...
    public List<Product> getProductsWithGreaterQuantity(int quantity)
    {
        ...
        try{
            ...
            System.out.println("Exception occurred in the getProductsWithGreaterQuantity() method: " + e.getMessage());
        } finally {
            try {
                if (rs != null) {
                    rs.close();
                ...
                System.out.println("Exception occurred in the finally section of the getProductsWithGreaterQuantity() method: " + e.getMessage());
            }
        }
    ...
    public int updateProductName(String productCode, String newProductName)
    {
        ...
        try{
            ...
            System.out.println("Exception occurred in the updateProductName() method: " + e.getMessage());
        } finally {
            try {
                if (ps != null) {
                    ps.close();
                ...
                System.out.println("Exception occurred in the finally section of the updateProductName() method");
                e.getMessage();
            }
        }
